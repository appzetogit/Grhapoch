...
export const API_ENDPOINTS = {
  ...
  RESTAURANT: {
    ...
    COMPLAINT_MISMATCH_REVIEW: '/restaurant/complaints/:id/mismatch-review',
  ...
  ADMIN: {
    ...
    SERVICE_SETTINGS: '/admin/service-settings',
    ...
    RESTAURANT_COMPLAINT_MISMATCH_ACTION: '/admin/restaurant-complaints/:id/mismatch-action',
