    ...
    <div className="p-4 lg:p-6 bg-slate-50 min-h-screen">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-4 mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          ...
          <div>
            <label className="block text-xs font-semibold text-slate-700 mb-1.5">Business UPI ID (for QR)</label>
            <input className="w-full px-3 py-2 text-sm border border-slate-300 rounded-lg"
              placeholder="e.g., merchant@upi"
              value={settings.upiId} onChange={(e) => handleSettingsChange("upiId", e.target.value)} />
            <p className="text-[10px] text-slate-400 mt-1">Used to generate dynamic QR codes for delivery boys.</p>
          </div>
        </div>
        <div className="mt-3">
          <button
