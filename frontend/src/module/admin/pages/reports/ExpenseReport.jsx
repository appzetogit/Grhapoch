...
export default function ExpenseReport() {
  ...
  const activeFiltersCount = (filters.restaurant !== "All restaurants" ? 1 : 0) + (filters.customer !== "All customers" ? 1 : 0) + (filters.type !== "All Type" ? 1 : 0) + (filters.time !== "All Time" ? 1 : 0);
