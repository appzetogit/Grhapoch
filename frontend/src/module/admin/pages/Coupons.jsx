...
export default function Coupons() {
  ...
  const resetForm = () => {
    ...
    if (editingId) {
      // If editing, we keep the editingId but reset data to initial
      // or we can just keep it as is. Usually reset means clear fields.
    }
  };
            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="md:col-span-2 lg:col-span-3 flex justify-end gap-3 pt-4 border-t border-slate-100">
                ...
                <button
                  type="button"
                  onClick={closeForm}
                  className="px-6 py-2 rounded-lg font-semibold text-red-600 hover:bg-red-50 transition-colors"
                >
                  Cancel
                </button>
                <button
