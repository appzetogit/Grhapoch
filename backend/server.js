...
import codeOfConductPublicRoutes from './routes/codeOfConductPublicRoutes.js';
...
app.use('/api', codeOfConductPublicRoutes);
...
app.use('/api/support/public', supportPublicRoutes);
